...
- **Phone screenshots (1080×1920, 9:16):** `assets/store/screenshots/01-home.png … 04-profile.png`. The same 4 satisfy **7-inch and 10-inch tablet** specs too (1080–7680px) — reuse them there.
