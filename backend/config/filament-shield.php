...
return [
    ...
    */
    ...
    'super_admin' => [
        'enabled' => true,
        // The product owner's "admin" role IS the super admin: unrestricted
        // access to everything (locations + user/role management) via a
        // Gate::before bypass. define_via_gate=true registers that bypass so
        // the admin role short-circuits every policy/permission check.
        'name' => 'admin',
    ...
    */
    ...
    'panel_user' => [
        // Disabled: 'contributor' is our base self-registration role instead
        // of Shield's generic panel_user.
        'enabled' => false,
        'name' => 'panel_user',
    ],
